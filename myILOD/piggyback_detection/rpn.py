...
class Piggyback_PRNHead(nn.Module):
    def __init__(self, in_channels, num_anchors, mask_init='1s', mask_scale=6e-3):
        super(Piggyback_PRNHead, self).__init__()
        self.conv = ElementWiseConv2d(
            in_channels, in_channels, kernel_size=3, stride=1, padding=1,
            mask_init=mask_init, mask_scale=6e-3)
        self.cls_logits = ElementWiseConv2d(in_channels, num_anchors, kernel_size=1, stride=1, 
            mask_init=mask_init, mask_scale=6e-3)
        self.bbox_pred = ElementWiseConv2d(in_channels, num_anchors * 4, kernel_size=1, stride=1, 
            mask_init=mask_init, mask_scale=6e-3)
