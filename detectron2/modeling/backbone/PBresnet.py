...
class BasicBlock(CNNBlockBase):
    ...
    def __init__(self, in_channels, out_channels, *, stride=1, norm="BN"):
        ...
        print("---------------------------------{}".format(get_norm(norm, out_channels)))
        if in_channels != out_channels:
            self.shortcut = ElementWiseConv2d(
                in_channels,
                out_channels,
                kernel_size=1,
                stride=stride,
...
class DeformBottleneckBlock(CNNBlockBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.conv2_offset = ElementWiseConv2d(
            bottleneck_channels,
...
class ResNet(Backbone):
    ...
    def __init__(self, stem, stages, num_classes=None, out_features=None):
        ...
        if num_classes is not None:
            ...
            self.linear = ElementWiseLinear(curr_channels, num_classes)
...
def build_PBresnet_backbone(cfg, input_shape):
    """
